...
export const SERVICE_DETAILS = [
  ...
  },
  {
    ...
    description:
      'We help you evaluate options, define the right technology approach, and make practical decisions aligned with your business goals.',
    features: [
      'Technology Strategy',
    ...
    image: '/images/technology-consulting-strategy-architecture.png',
    imageAlt: 'Isometric illustration of a technology strategy and architecture planning roadmap',
    imageScale: 1.1,
    imageObjectPosition: '35% center',
  ...
  },
  {
    ...
    description:
      'We build secure, scalable web applications tailored to your workflows, users, and business goals.',
    features: [
      'Business Portals',
      'Internal Tools',
      'Custom Dashboards',
    ...
    image: '/images/custom-web-application-enterprise-illustration.png',
    imageAlt: 'Isometric illustration of a custom enterprise web application dashboard',
    ctaLabel: 'Explore Custom Applications',
    imageSide: 'right',
  },
  {
    number: '06',
    ...
    description:
      'We provide ongoing support, monitoring, maintenance, and improvements to keep your digital systems secure, stable, and performing at their best.',
    features: [
      'Ongoing Maintenance',
    ...
    image: '/images/maintenance-monitoring-support-illustration.png',
    imageAlt: 'Isometric illustration of server maintenance, monitoring, and support tools',
...
export const TESTIMONIALS = [
  {
    quote:
      'Chaufal Tech understood our requirements perfectly and delivered a solution ahead of schedule.',
    name: 'Ravi Chopra',
    role: 'Founder, Startup',
  },
  {
    quote:
      'Their automation work saved our team hours every week. Communication was smooth the entire way.',
    name: 'Nisha Verma',
    role: 'Operations Lead, Retail',
  },
  {
    quote:
      'Professional, reliable, and genuinely invested in outcomes — Chaufal Tech is who we call now.',
    name: 'Arjun Mehta',
    role: 'Director, Logistics',
  },
  {
    quote:
      'They took the time to understand our business before proposing anything. That made all the difference.',
    name: 'Priya Nair',
    role: 'Owner, Local Enterprise',
  },
  {
    quote:
      'On time, on budget, and clear communication throughout. Exactly what we needed for our modernization project.',
    name: 'Daniel Osei',
    role: 'CTO, Established Org',
  },
]

export const PROJECTS = [
  {
    title: 'Business Website — Industrial Solutions',
...
export const BLOG_POSTS = [
  {
    title: 'Why Every Business Needs a Technology Partner, Not Just a Vendor',
    excerpt:
      'The difference between hiring an agency and building a long-term technology partnership — and why it matters for growth.',
    date: 'Coming soon',
  },
  {
    title: '5 Signs Your Business Is Ready for Automation',
    excerpt:
      'How to know when manual processes are costing you more than the automation would.',
    date: 'Coming soon',
  },
  {
    title: 'Modernizing Legacy Systems Without Disrupting Operations',
    excerpt: 'A practical approach to upgrading critical systems while the business keeps running.',
    date: 'Coming soon',
  },
]